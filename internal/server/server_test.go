...
import (
	...
	api "github.com/alankritjoshi/logroom/api/v1"
	"github.com/alankritjoshi/logroom/internal/auth"
	"github.com/alankritjoshi/logroom/internal/config"
	"github.com/alankritjoshi/logroom/internal/log"
...
func setupTest(t *testing.T, fn func(*Config)) (
	...
	serverTLSConfig, err := config.SetupTLSConfig(config.TLSConfig{
		CertFile: config.ServerCertificate,
