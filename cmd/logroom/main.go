...
import (
	...
	"github.com/alankritjoshi/logroom/internal/agent"
	"github.com/alankritjoshi/logroom/internal/config"
...
func setupFlags(cmd *cobra.Command) error {
	...
	cmd.Flags().String("config-file", "", "Path tp config file.")

	dataDir := path.Join(os.TempDir(), "logroom")
	...
	cmd.Flags().String("server-tls-ca-file", "", "Path to peer certificate authority.")
